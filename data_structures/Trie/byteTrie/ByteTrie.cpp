...
//#include "../IOTests/GLOB.h" //precompiled header, basic classes etc.

#ifdef _DEBUG
	//Undefine for avoiding use of std::vector etc.
	#undef _DEBUG
