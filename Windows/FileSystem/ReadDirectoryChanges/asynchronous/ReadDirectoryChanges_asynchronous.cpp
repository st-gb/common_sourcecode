  ...
  )
{
  ...
  //g_handleDirectory
  r_readdirectorychangeswparameters.handleDirectory = GetHandleToDirectory(
    //ps_fswatch
    r_readdirectorychangeswparameters.stdwstrRootPath, true) ;
...
//    & r_readdirectorychangeswparameters.overlapped ,
  ...
  {
    LOGN("ReadDirectoryChangesW failes")
...
//      TRUE, // initial state = signaled
    ...
    p_readdirectorychangeswparameters->overlapped.hEvent = ::CreateEvent(
      NULL,    // default security attribute
      TRUE,    // manual reset event
//      TRUE, // initial state = signaled
      FALSE, // FALSE=initial state = non-signaled
...
BYTE Windows::ReadDirectoryChanges_asynchronous::WatchSubTree(
