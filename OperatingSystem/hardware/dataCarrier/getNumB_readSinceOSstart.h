 ...
 * OS=Operating System: http://www.abbreviations.com/OS */\
 ! defined TU_Bln361095OpSys_hardware_dataCarrier_getNumB_readSinceOSstart_h
   #define TU_Bln361095OpSys_hardware_dataCarrier_getNumB_readSinceOSstart_h
 ...
 * Put definition between "[...]NmSpcBgn" and "[...]NmSpcEnd" #define'd below.*/
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartDef(suffix) suffix
/**Nm=NaMe: http://www.abbreviations.com/abbreviation/name
 * Spc=SPaCe: http://www.abbreviations.com/abbreviation/Space */
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartNmSpc\
    TU_Bln361095OpSysDataCarrierNmSpc ::\
/**Do not append "::" right of the rightmost namespace name to enable
 * "using namespace [...]GetNumReadBsinceOSstartNmSpc"*/\
      getNumReadBsinceOSstart
///Bgn=BeGiN: http://www.allacronyms.com/begin/abbreviated
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartNmSpcBgn\
    TU_Bln361095OpSysDataCarrierNmSpcBgn namespace getNumReadBsinceOSstart{
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartNmSpcEnd\
    TU_Bln361095OpSysDataCarrierNmSpcEnd }  
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartUse(suffix)\
    TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartNmSpc :: suffix
#else
///Def=DEFinition: http://www.abbreviations.com/abbreviation/definition
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartDef(suffix)\
 ...
 * expansion."*/\
      GetNumReadBsinceOSstart ## suffix)
/**Nm=NaMe: http://www.abbreviations.com/abbreviation/name
 * Spc=SPaCe: http://www.abbreviations.com/abbreviation/Space */
...
///Bgn=BeGiN: http://www.allacronyms.com/begin/abbreviated
  ...
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartNmSpcEnd
  #define TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartUse(suffix)\
    TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartDef(suffix)
#endif

TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartNmSpcBgn

enum TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartDef(Rslt) {
  TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartDef(Success) = 0,
  TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartDef(OpenDataCarrierFaild),
  TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartDef(Error)
};

TU_Bln361095OpSysDataCarrierGetNumReadBsinceOSstartNmSpcEnd

#ifdef __linux__
  #include <OperatingSystem/Unix/hardware/dataCarrier/getNumB_readSinceOSstart.hpp>
#endif
#ifdef /*_WIN32*/TU_Bln361095MicroSoftWindows
  #include <OperatingSystem/Windows/hardware/dataCarrier/getNumB_readSinceOSstart.h>
#endif
